...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<'generator' | 'reports'>('generator')
  ...
  useEffect(() => {
    if (!search) {
        ...
        const filtered = allPoints.filter(p => {
            ...
            return naam.toLowerCase().includes(lowerSearch) || straat.toLowerCase().includes(lowerSearch)
        })
  ...
  const getPuntId = (props: any) => {
    return props.id || props.objectid || props.agent || props.recordid || "onbekend";
  }
    ...
    <div className="min-h-screen bg-gray-50 p-8 font-sans">
      <div className="max-w-6xl mx-auto">
        <header className="mb-8 flex justify-between items-center">
            <h1 className="text-3xl font-bold text-gray-900">🚰 WaterGent Admin</h1>
            <div className="flex gap-2">
                ...
                <button 
                    ...
                    className={`px-4 py-2 rounded font-bold ${activeTab === 'reports' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600'}`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 bg-white rounded-xl shadow-md overflow-hidden flex flex-col h-[80vh]">
                    <div className="p-4 border-b bg-gray-50">
                        <h2 className="font-bold text-lg mb-2">Alle Locaties ({allPoints.length})</h2>
                        <input 
                            type="text" 
                    ...
                    <div className="overflow-y-auto flex-1 p-0">
                        {filteredPoints.map((point, i) => {
                            ...
                            const adres = point.properties.straatnaam || point.properties.adres || point.properties.locatie || "";

                            return (
                                <div key={i} className="border-b p-4 flex justify-between items-center hover:bg-blue-50 transition">
                                    <div>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 sticky top-6 text-center">
                        {selectedQrPoint ? (
                            ...
                            <div className="h-64 flex flex-col items-center justify-center text-gray-400">
                                ...
                                <p>Selecteer een locatie uit de lijst om de QR code te maken.</p>
                            </div>
                        )}
                    </div>
                </div>
